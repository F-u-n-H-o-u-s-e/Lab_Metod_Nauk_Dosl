...
for i in range(3):
    ...
    X_matr_natur = [[10, -70, 60],[10, -70, 70],[10, -10, 60],[10, -10, 70],
        [60, -70, 60],[60, -70, 70],[60, -10, 60],[60, -10, 70],]
    ...
    while not flag:
        ...
        for i in range(N):
            print("{0:=d} {1:=4d} {2:=3d} {3:=3d} {4:=9.5f} {5:=9.5f} {6:=9.5f}".format(i + 1,X_matr[i][0], X_matr[i][1], X_matr[i][2], Y_matr[i][0], Y_matr[i][1], Y_matr[i][2]))
        print('##' * 40, '\n')
...
print("Час виконання: {} second".format(a))
